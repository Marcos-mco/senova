...
*Atualizado: 13/ago/2026 — **Sessão 45 · Nasceu o agente `senova-viabilidade`; achou sozinho uma corrida real no contador de custo e destravou o cache da Anthropic em dois pontos. Na mesma sessão: o clique do Kanban voltou a abrir o card (CONFIRMADO por Marcos), seleção múltipla ganhou mover-em-lote (no ar, aguardando teste), e a auditoria do Perfil confirmou que ele é write-only — a IA usa identidade hardcoded que hoje contradiz o que Marcos configurou. Sessão dedicada só ao Perfil marcada para 14/ago.**.*
