...
- **Gerente Nacional de Produção** — abr/1996 a 2001
  ...
  - Implantou computação gráfica nacional e color management — perfis ICC e calibração de equipamentos de impressão
...
- Produtor gráfico da primeira revista 100% em computação gráfica do Brasil — Guia da TVA (Editora Abril/TVA), publicação mensal — trabalho pioneiro que resultou em convite para integrar a Editora Abril
- Revenda e assistência técnica autorizada Apple em São Paulo — comercialização de hardware, impressoras (LaserWriter, ImageWriter) e periféricos gráficos em plataforma Macintosh

**DLS – DÓRIA, LARA E STALIMIR ASSOCIADOS** — Produtor Gráfico — 1989 a 1990
- Uma das agências de publicidade mais relevantes do Brasil na época — fundada por João Dória, Luiz Lara e Stalimir Vieira, três referências nacionais do setor
- Agência de publicidade em São Paulo

**Regras de uso da DLS:**
- DLS NUNCA deve ser omitida do CV_BASE
- Vagas marketing/comunicação/publicidade: destaque completo com nomes dos sócios
- Vagas gráficas/editoriais: menção como origem da carreira gráfica
- Vagas comerciais/C-Level: 1 linha com nome completo da agência
- Vagas tech/SaaS: omitir ou 1 linha no rodapé
...
- MBA em Administração de Empresas · FGV Curitiba (1998–2000) — NUNCA associar a Marketing; Marketing aparece apenas no Master's Barcelona e no Mestrado Évora
