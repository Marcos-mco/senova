...
t('com o curso, a instituição e o período', exec(s, `_formDados.find(f=>/Évora/.test(f.instituicao)).titulo`) === 'Mestrado em Gestão de Empresas, especialização em Marketing');
