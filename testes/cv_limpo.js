...
const fontes=['function _jobIdLinkedIn(','function _acharVagaRef(','function _extrairSoCV(','window.__senovaCopilotoSalvarCV=function(','window.__senovaCopilotoGerarCV=function('].map(extrai).join('\n;\n');
const sandbox={vagas:[],saveVagas:()=>{},document:{getElementById:()=>null},MODELOS:{analise:'m'},ATS_SYSTEM:()=>'SYS',lastCV:'',lastCVFilename:'',_pdfExecBase64:()=>'FAKEB64',btoa:s=>Buffer.from(s,'binary').toString('base64'),unescape:global.unescape||(s=>decodeURIComponent(s)),encodeURIComponent,console};
