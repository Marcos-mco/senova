...
const fontes = [
  ...
  // A formação entra no prompt pela mesma porta (perfilFormatadoPara) e tem o mesmo desenho.
  ...
  // O contato entra pela mesma porta (perfilFormatadoPara) e tem o mesmo desenho.
