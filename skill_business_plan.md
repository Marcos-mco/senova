...
- Calcular viabilidade financeira (precificação, CAC, LTV, break-even)
- Estruturar pitch para investidores ou parceiros
- Definir estratégia de go-to-market
- Avaliar expansão para outros usuários além de Marcos
- Comparar com concorrentes nacionais e internacionais

## Contexto atual do negócio
- **Produto:** Senova Suite — plataforma de recolocação executiva com IA
...
## Modelo de receita sugerido (a validar)
- Freemium: acesso básico gratuito (Anti-ATS limitado)
- Pro: R$47/mês (CRM completo + Inteligência de Mercado + Simulador)
- Executive: R$97/mês (tudo + consultoria humana via parceiros)

## Framework de business plan
1. Problema e solução
2. Mercado-alvo e TAM/SAM/SOM
3. Modelo de receita e precificação
4. Go-to-market (como chegar ao primeiro cliente pagante)
5. Projeção financeira 12/24/36 meses
6. Riscos e mitigações
7. Próximos marcos (milestones)

## Premissas financeiras base (atualizar conforme evolução)
- Custo Anthropic API: ~$0.003 por interação média
- Custo Cloudflare: gratuito até 100k req/dia
- Custo GitHub Pages: gratuito
- Custo domínio senova.com.br: ~R$47/ano
- Custo total fixo estimado hoje: < R$100/mês
