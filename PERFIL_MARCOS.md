...
*Extraído do VIRGILIO.md em 26/mai/2026 para economizar tokens na leitura de sessão*
*Ler apenas quando necessário (CV, cartas, pesquisa executiva)*
...
- **Superintendente Regional de Vendas – Nordeste** — 2001 a fev/2005
  - Equipe 45 pessoas em AL e SE | Orçamento R$5mi/ano
  - Docência paralela: ESAMC/ESPM Maceió (2002–04)
  - Prêmio Troféu Imprensa 2004 — campanha RSE reciclagem listas

- **Gerente Nacional de Produção** — abr/1996 a 2001
  - Equipe até 50 pessoas; produção editorial em 5 estados
  - Implantou células de autogestão: mão de obra -73%, produção +240%
  - Implantou computação gráfica nacional e color management (perfis ICC, calibração)
  - ISO 9000: Auditor Líder e membro do comitê

**GHAPHICAL CONSULT** — Consultor Independente — 1995 a 1996
- Principal cliente: Posigraf (Curitiba/PR) — motivou relocação SP→Curitiba
- Clientes: Editora Abril, Posigraf, Editora Símbolo, Gráfica Ultraset, Qualidart, Gráfica Balcos
- Especialização em color management: calibração, gestão de cores, perfis ICC
...
- Produtor gráfico da primeira revista 100% em computação gráfica do Brasil — Guia da TVA (Editora Abril/TVA)
- Revenda e assistência técnica autorizada Apple: hardware, LaserWriter, ImageWriter, periféricos

**DLS – DÓRIA, LARA E STALIMIR ASSOCIADOS** — Produtor Gráfico — 1989 a 1990
- Fundada por João Dória, Luiz Lara e Stalimir Vieira
- **DLS NUNCA deve ser omitida do CV_BASE**
- **GANCHO ESTRATÉGICO:** João Dória = conexão com Heloisa Garrett (LIDE Paraná)

### Regras DLS por tipo de vaga
- Marketing/comunicação/publicidade: destaque completo com nomes dos sócios
- Gráficas/editoriais: menção como origem da carreira gráfica
- C-Level/comercial: 1 linha com nome completo da agência
- Tech/SaaS: omitir ou 1 linha no rodapé

---

## Informações complementares
- **Docência:** ESAMC/ESPM Maceió (2002–04) + Uniexp Curitiba (2006)
- **Certificação:** ISO 9000 — Auditor Líder e membro do comitê
...
- Espanhol: avançado (nunca "fluente")
- Alemão: NÃO fala

---

## Contatos estratégicos ativos (atualizar conforme evoluem)

### Quentes / Em processo
- **Giuliano Sarzana** (NEO AdTech) — QUENTE
- **Ronny Essert** (GERAR) — material societal marketing enviado?

### Aguardando
- **Alan Ceppini** (RICTV) — reunião 13/mai — aguardar antes de contatar Petrelli/Ney Braga
...
- Reserva financeira: 3–4 meses — prioridade é estabilidade
